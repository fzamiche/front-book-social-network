...
import { registrer } from '../fn/authentication/registrer';
import { Registrer$Params } from '../fn/authentication/registrer';
...
export class AuthenticationService extends BaseService {
  ...
  /** Path part for operation `registrer()` */
  static readonly RegistrerPath = '/auth/register';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `registrer()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registrer$Response(params: Registrer$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return registrer(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `registrer$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registrer(params: Registrer$Params, context?: HttpContext): Observable<{
}> {
    return this.registrer$Response(params, context).pipe(
