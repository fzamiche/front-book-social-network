...
import { approuveReturnBorrowedBook } from '../fn/book/approuve-return-borrowed-book';
import { ApprouveReturnBorrowedBook$Params } from '../fn/book/approuve-return-borrowed-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approuveReturnBorrowedBook()` */
  static readonly ApprouveReturnBorrowedBookPath = '/books/borrow/approuve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approuveReturnBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approuveReturnBorrowedBook$Response(params: ApprouveReturnBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approuveReturnBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approuveReturnBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approuveReturnBorrowedBook(params: ApprouveReturnBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approuveReturnBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

  /** Path part for operation `updateShareableStatusBook()` */
  static readonly UpdateShareableStatusBookPath = '/books/shareable/{book-id}';
  ...
  static readonly UpdateArchivedStatusBookPath = '/books/archived/{book-id}';
